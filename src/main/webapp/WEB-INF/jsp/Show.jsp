...
<c:forEach items="${shows}" var="std">
                        ...
                        <tr>
                            ...
                            <ul class="action-list">
                                <li><a href="edit/${std.id_Student}" class="btn btn-primary"><i class="fa fa-pencil"></i></a></li>
                                <li><a href="delete/${std.id_Student}" class="btn btn-danger"><i class="fa fa-trash"></i></a></li>
                            </ul>
                        </td>
                        </tr>
</c:forEach>
